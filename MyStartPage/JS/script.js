...
StartPage.prototype.imgRandom = function() {
  ...
  if (nRandom == 1) {
    ...
    var imagen = "Img/card/IPNwine_0";
    for (var i = 0; i <= 5; i++) {
      document.getElementById("imgGrid" + arrayIMG[i]).src = imagen + (i + 1) + ".png";
    }
  } else if (nRandom == 2) {
    document.getElementsByTagName("BODY")[0].style.background = "#000";
    var imagen = "Img/card/IPNblack_0";
    for (var i = 0; i <= 5; i++) {
      document.getElementsByClassName("direction-reveal__overlay")[i].style.background = "#762640";
      document.getElementById("imgGrid" + arrayIMG[i]).src = imagen + (i + 1) + ".png";
    }
  } else if (nRandom == 3) {
    document.getElementsByTagName("BODY")[0].style.background = "#000";
    var imagen = "Img/card/IPN2black_0";
    for (var i = 0; i <= 5; i++) {
      document.getElementsByClassName("direction-reveal__overlay")[i].style.background = "#762640";
      document.getElementById("imgGrid" + arrayIMG[i]).src = imagen + (i + 1) + ".png";
    }

...
StartPage.prototype.imgRandom = function() {
  ...
  if (nRandom == 1) {
    document.getElementsByTagName("BODY")[0].style.background = "#75003E";
    var imagen = "Images/card/IPNwine_0";
    for (var i = 0; i <= 5; i++) {
      document.getElementById("imgGrid" + arrayIMG[i]).src = imagen + (i + 1) + ".jpg";
    }
  } else if (nRandom == 2) {
    document.getElementsByTagName("BODY")[0].style.background = "#000";
    var imagen = "Images/card/IPNblack_0";
    for (var i = 0; i <= 5; i++) {
      document.getElementsByClassName("direction-reveal__overlay")[i].style.background = "#75003E";
      document.getElementById("imgGrid" + arrayIMG[i]).src = imagen + (i + 1) + ".jpg";
    }
  } else if (nRandom == 3) {
    document.getElementsByTagName("BODY")[0].style.background = "#000";
    var imagen = "Images/card/IPN2black_0";
    for (var i = 0; i <= 5; i++) {
      document.getElementsByClassName("direction-reveal__overlay")[i].style.background = "#75003E";
      document.getElementById("imgGrid" + arrayIMG[i]).src = imagen + (i + 1) + ".jpg";
    }
...
StartPage.prototype.youtubeOver = function () {
  ...
  document.getElementById("searchElementYouTube").style.borderRadius = "3px";
};
...
StartPage.prototype.duckduckgoOver = function () {
  ...
  document.getElementById("searchElementDuckduckgo").style.borderRadius = "3px";
};
...
StartPage.prototype.yandexOver = function () {
  ...
  document.getElementById("searchElementYandex").style.borderRadius = "3px";
};
...
StartPage.prototype.consolaInformacion = function(){
    ...
    var rabbit = console.log("   =('_')=");
    var version = console.log("Version: 2.0.1");
